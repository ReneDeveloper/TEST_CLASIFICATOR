...
#            cv2.putText(img, f'{ "H"+str(half_altura)}',(x-25, y + 75), font, 0.5, colors_TYPE_, 2)
            ...
            img_sub_path = "C:/RSILVA_BOT_BASICS/ETL_CADEM/VISION_ARTIFICIAL/DEMO_OBJETOS/PALETA_FILES_5_CLUSTER"
...
def _RSILVA_20220330_visualize_Dominant_colors__(cluster, C_centroids):
    ...
    for (percent, color) in img_colors:
        ...
        string_COLOR_tmp = str(
            int(color[0])) + "_" + str(int(color[1])) + "_" + str(int(color[2]))
...
def __paleta__(path_, file_):
    ...
    visualize_color_salida = _RSILVA_20220330_visualize_Dominant_colors__(
